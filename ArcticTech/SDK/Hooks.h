...
typedef void(__fastcall* tProcessPacket)(INetChannel*, void*, void*, bool);
typedef int(__fastcall* tProcessInterpolatedList)();
...
inline tProcessPacket oProcessPacket;
inline tProcessInterpolatedList oProcessInterpolatedList;
