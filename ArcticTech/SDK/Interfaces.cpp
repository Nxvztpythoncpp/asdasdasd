...
void Interfaces::Initialize() {
	...
	MaterialSystemHardwareConfig = (IMaterialSystemHardwareConfig*)Utils::CreateInterface("materialsystem.dll", "MaterialSystemHardwareConfig013");
	...
	EventInfo = *reinterpret_cast<CEventInfo**>(reinterpret_cast<std::uintptr_t>(ClientState) + 0x4E6C);
