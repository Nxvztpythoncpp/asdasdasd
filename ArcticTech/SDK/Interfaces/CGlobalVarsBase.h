...
//https://github.com/opai-create/airflow-csgo-cheat/blob/c6341cb4449b424a69fb22fd5bc7f480e2f846e5/v1/Airflow/base/interfaces/engine.h#L564
class CEventInfo
{
public:
    short class_id{};
    std::array<std::byte, 2> pad1{};
    float fire_delay{};
    ...
    uint8_t* data{};
    int flags{};
    std::array<std::byte, 28> pad2{};       // padding(0x1C)
    CEventInfo* next{};
    std::array<std::byte, 4> pad3{};
};

//https://github.com/spirthack/CSGOSimple/blob/master/CSGOSimple/valve_sdk/interfaces/CClientState.hpp#L64
class CClientState
{
public:
