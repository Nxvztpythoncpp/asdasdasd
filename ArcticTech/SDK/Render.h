...
public:
    ...
    void                gradient_text(const std::string& text, const Vector2& pos, Color start_color, Color end_color, float alpha, D3DXFont* font, int flags);
...
extern std::unique_ptr<CRender> Render;